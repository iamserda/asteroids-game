import pygame
import random
from constants import ASTEROID_MAX_RADIUS, ASTEROID_MIN_RADIUS, ASTEROID_KINDS, ASTEROID_SPAWN_RATE_SECONDS, SCREEN_HEIGHT, SCREEN_WIDTH
...
class AsteroidField(pygame.sprite.Sprite):
    edges = [
        ...
        [pygame.Vector2(0, -1), lambda x: pygame.Vector2(x * SCREEN_WIDTH, ASTEROID_MAX_RADIUS + SCREEN_HEIGHT)],
    ]
